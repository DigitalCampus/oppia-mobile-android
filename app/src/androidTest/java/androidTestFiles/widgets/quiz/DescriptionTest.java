...
public class DescriptionTest extends BaseQuizTest {

    private static final String DESCRIPTION_QUESTION_JSON =
            BaseTest.PATH_QUIZZES + "/description_question.json";
    private static final String FIRST_QUESTION_TITLE = "Answer the following questions about European capitals";

    @Override
    protected String getQuizContentFile() {
        return DESCRIPTION_QUESTION_JSON;
    }
