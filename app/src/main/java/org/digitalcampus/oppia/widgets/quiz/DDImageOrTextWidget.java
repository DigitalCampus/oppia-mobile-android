...
public class DDImageOrTextWidget extends TextInputQuizWidget{

	public static final String TAG = ShortAnswerWidget.class.getSimpleName();

	public DDImageOrTextWidget(Activity activity, View v, ViewGroup container) {
		init(activity, container ,R.layout.widget_quiz_ddimageortext,v);
	}
