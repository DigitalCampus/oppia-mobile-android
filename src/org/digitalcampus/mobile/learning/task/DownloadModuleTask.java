	...
	protected Payload doInBackground(Payload... params) {
		...
		for (Payload payload : params) {
			...
			try { 
				...
				new DefaultHttpClient().execute(new HttpGet(dm.getDownloadUrl())).getEntity().writeTo(new FileOutputStream(new File(MobileLearning.DOWNLOAD_PATH,localFileName)));
