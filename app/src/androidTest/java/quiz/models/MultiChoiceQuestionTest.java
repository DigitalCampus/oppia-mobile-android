...
public class MultiChoiceQuestionTest {
    ...
    private static final String MULTICHOICE_NOFEEDBACK_JSON = "quizzes/multichoice_nofeedback.json";
    private static final String MULTICHOICE_WITHFEEDBACK_JSON = "quizzes/multichoice_withfeedback.json";
